...
@section('content')
    ...
    <div class="mainBox photoDetails">
        <div class="photoInfo">
            ...
            <div class="stats"> <span class="views">Lượt xem:<span class="number">{{ $product_detail->view }}</span></span> <span class="comments">Lượt bình luận: <span class="number">{{ $product_detail->comment }}</span></span>
            </div>
            <div class="source"> <span class="source"> Nguồn: <span class="text">{{ $product_detail->source }}</span> </span>
            </div>
        </div>
        <div class="uploader">
            Đăng
        ...
        <div class="likeButton fixedScroll " style="position: relative;">
            ...
            <div class="fbLikeButton">
                <div class="fb-like" data-href="{{ url('detail', $product_detail->alias) }}" data-layout="button" data-action="like" data-size="small" data-show-faces="true" data-share="true">
                </div>
            </div>
        ...
        <div class="clear"> </div>
        <div class="photoImg"> 
            <img alt="{{ $product_detail->title }}" src="{{ asset('upload/images/'.$product_detail->image) }}"> 
        </div>
        {{-- img detail --}}
